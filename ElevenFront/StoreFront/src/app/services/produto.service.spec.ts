...
describe('ProdutoService', () => {
  ...
  it('should retrieve produto by id', () => {
    ...
    const req = httpMock.expectOne('http://192.168.56.102:8080/api/produto/1');
  ...
  it('should retrieve all produtos', () => {
    ...
    const req = httpMock.expectOne('http://192.168.56.102:8080/api/produto');
    expect(req.request.method).toBe('GET');
  ...
  it('should retrieve produto by nome', () => {
    ...
    const req = httpMock.expectOne('http://192.168.56.102:8080/api/produto/nome/Produto1');
    expect(req.request.method).toBe('GET');
    req.flush(mockProduto);
  });
  ...
  it('should retrieve produtos by ativo', () => {
    ...
    const req = httpMock.expectOne('http://192.168.56.102:8080/api/produto/ativo/true');
    expect(req.request.method).toBe('GET');
    req.flush(mockProdutos);
  });
  ...
  it('should retrieve produtos by dia de atualizar', () => {
    ...
    const req = httpMock.expectOne('http://192.168.56.102:8080/api/produto/atualizar/dia/2023-12-01');
    expect(req.request.method).toBe('GET');
    req.flush(mockProdutos);
  });
  ...
  it('should update produto by id', () => {
    ...
    const req = httpMock.expectOne('http://192.168.56.102:8080/api/produto/nome/1');
  ...
  it('should delete produto by id', () => {
    ...
    const req = httpMock.expectOne('http://192.168.56.102:8080/api/produto/desativar/1');
