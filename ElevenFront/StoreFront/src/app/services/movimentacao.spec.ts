...
describe('MovimentacaoService', () => {
  ...
  it('should retrieve all movimentacoes', () => {
    ...
    const req = httpMock.expectOne('http://192.168.4.157:8080/api/movimentacao');
  ...
  it('should update movimentacao by id', () => {
    ...
    const req = httpMock.expectOne('http://192.168.4.157:8080/api/movimentacao/atualizar/1');
