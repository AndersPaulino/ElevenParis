...
describe('EstoqueService', () => {
  ...
  it('should retrieve all estoques', () => {
    ...
    const req = httpMock.expectOne('http://192.168.56.102:8080/api/estoque');
  ...
  it('should retrieve estoque by id', () => {
    ...
    const req = httpMock.expectOne('http://192.168.56.102:8080/api/estoque/1');
    expect(req.request.method).toBe('GET');
  ...
  it('should update estoque by id', () => {
    ...
    const req = httpMock.expectOne('http://192.168.56.102:8080/api/estoque/nome/1');
