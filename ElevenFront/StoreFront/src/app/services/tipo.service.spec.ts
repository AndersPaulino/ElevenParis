...
describe('TipoService', () => {
  ...
  it('should retrieve all tipos', () => {
    ...
    const req = httpMock.expectOne('http://192.168.56.102:8080/api/tipo');
  ...
  it('should retrieve tipo by id', () => {
    ...
    const req = httpMock.expectOne('http://192.168.56.102:8080/api/tipo/1');
    expect(req.request.method).toBe('GET');
    req.flush(mockTipo);
  });
  ...
  it('should retrieve tipos by ativo', () => {
    ...
    const req = httpMock.expectOne('http://192.168.56.102:8080/api/tipo/ativo/true');
    expect(req.request.method).toBe('GET');
    req.flush(mockTipos);
  });
  ...
  it('should update tipo by id', () => {
    ...
    const req = httpMock.expectOne('http://192.168.56.102:8080/api/tipo/nome/1');
  ...
  it('should delete tipo by id', () => {
    ...
    const req = httpMock.expectOne('http://192.168.56.102:8080/api/tipo/desativar/1');
